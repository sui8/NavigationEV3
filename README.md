...
- [ ] **v1.15.1** Helpタブ作成<ボタンは未作成>
- [ ] **v1.16.0** パック削除機能追加<破損していない場合に限る>
- [ ] **v1.17.0** Config.ini設定を読み込む機能修正<文字型対応>、Config.iniの設定ミスの際、デフォルトに戻す（カラー、フォント含め）、項目などの損失修正、ncp破損修復設定、拡大縮小設定
- [ ] **v1.18.0** ロボット画像変更可能化、パック破損時の自動削除
